...
<div class="container">
    ...
    <div class="text-center">
        <h2 class="underlinetext">ASSOCIATION OF UNAIDED COLLEGE TEACHERS </h2>
    ...
    <div class="mt-4">
        ...
        <ul class="changelistnumer">
            <li><b>MEMBERSHIP:</b> Membership is open for all Unaided teachers of affiliated colleges of Punjab
                ...
                governing Body of <b> ASSOCIATION OF UNAIDED COLLEGE TEACHERS, H. NO. 10, VILLA APARTMENTS, BALOKE
                    ROAD,
                    HAIBOWAL KALAN, LUDHIANA-141001 (PB.)</b>, who may accept or reject the same and the decision of
                the
                Governing body shall be final. On admission, every member shall sign the <b> “Register of
                    Members”</b>
                maintained by the Society.
            </li>
            <li>
                <b>SUBSCRIPTION:</b> Every member shall pay monthly or yearly subscription as prescribed by the
                Governing
                Body from time to time and shall deposit the same with the Cashier who will issue a proper receipt
                of the same.
            </li>
            <li><b>GOVERNING BODY</b> (Formation and functions)
                <ul class="changelistnumer2">
                    <li>
                        The affairs of the Society shall be managed by the body known as <b>“Governing body”</b>
                        which
            ...
            <li><b>FUNDS VESTED IN THE GOVERNING BODY: -</b> The funds (movable and immovable) of the society shall
                be
                vested in the Governing Body which shall have the power to administer the same.
            </li>
            <li>
                <b>MEETINGS:</b>
                <ul class="changelistnumer3">
                    <li><span class="underlinetext">The General Body Meeting</span>: shall be held at-least once in
                    ...
                    <li>
                        <span class="underlinetext">The Governing Body Meetings</span>: The Governing Body shall
                        meet once in at-least six months or as
                        it may deem fit in the interest of the work of the association.
                    </li>
                    <li><span class="underlinetext">Special Meetings</span>: The President of the society shall have
                    ...
                    <li><span class="underlinetext">Notice of Meeting</span>: The notice for the General Body
            ...
            <li>
                <b>QUORUM:</b> The minimum number needed to make a quorum to hold the meeting shall be one-third of
                the
            ...
            <li>
                <b>RESOLUTION:</b> All the resolutions and decisions at the meetings shall be taken by majority view
                or by
                election by the members present in the meeting.
            </li>
            <li><b>BANK ACCOUNT:</b> A bank account shall be opened in the name of the society and the same shall be
            ...
            <li>
                <b>INSPECTION OF RECORDS</b>: Every member of the society has the right to inspect the records of
                the
                Association and General Secretary shall grant the necessary permission for the same at all
                reasonable times.
            </li>
            <li>
                <b>ALTERATION IN RULES:</b> Any addition, alteration or omissions in the Rules & Regulations of the
                Society
            ...
            <li>
                <b>REMOVAL OF MEMBERS:</b> The governing body shall have the power to remove any member of
            ...
            <li>
                <b>CLOSING OF ACCOUNTS AND AUDIT THEREOF:</b> Regular accounts of the SOCIETY shall be maintained.
                The
            ...
            <li>
                <b>INVESTMENT OF FUNDS OF THE SOCIETY:</b> The funds of the SOCIETY shall be invested in the modes
            ...
            <li>
                <b>BENEFICIERIES OF THE SOCIETY:</b> The benefits of the SOCIETY shall be opened to all mankind
                irrespective of caste, creed or religion.
            </li>
            <li>
                <b>UTILISATION OF INCOME:</b> It is specifically provided that all the members of the SOCIETY
                including
            ...
            <li>
                <b>AMENDMENTS:</b> Any amendment of the memorandum of Association/Bye laws/Rules and regulations
                which may
            ...
            <li>
                <b>PRESIDENT:</b> The President of Society shall conduct regulate and preside all the meetings of
                the
            ...
            <li>
                <b>THE VICE–PRESIDENT:</b> In the absence of the President, the Vice-President shall presides all
                the
                meetings of the society and exercise all such powers.
            </li>
            <li>
                <b>THE GENERAL SECRETARY:</b> The general Secretary shall look after the affairs of the Society
                under the
            ...
            <li>
                <b>THE JOINT SECRETARY:</b> In the absence of General Secretary, the Joint Secretary will perform
                his
                duties.
            </li>
            <li>
                <b>THE FINANCE SECRETARY:</b> Finance Secretary shall act under the directions of the Governing
                body.
            ...
            <li>
                <b>DISSOLUTION:</b>
                <ul class="changelistnumer4">
                    <li>Any number not less than 3/5th of the members present at the meeting specially convened for
                        the purpose may determine that the Society shall be dissolved whether for with or at any
                        future time then agreed upon.
                    </li>
                    <li> If on the dissolution of the Society, there shall remain after the satisfaction of its
            ...
            <li>
                <b>GENERAL:</b>
                <ul class="changelistnumer4">
                    <li>The Society shall work within the ambit of Societies Registration Act, 1860.</li>
                    <li>The funds of the Society shall be spent for such purpose only as have been defined as
                        charitable
